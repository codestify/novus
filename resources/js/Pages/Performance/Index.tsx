...
const Index = () => {
    ...
    const { performanceData, seoData, periodOptions } = page.props;
    ...
    const handlePeriodChange = (value: string) => {
        ...
        router.visit(route("novus.performance"), {
            data: { period: value },
            preserveState: true,
        ...
        if (active && payload && payload.length) {
            return (
                <div className="p-3 rounded-lg border shadow-sm bg-background">
                    <p className="font-medium">{formatDateWithDay(label)}</p>
    ...
    return (
        <AuthLayout title="Your Website Performance">
