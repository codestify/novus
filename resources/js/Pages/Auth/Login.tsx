...
const NovusLogin = () => {
    ...
    //     "<p>Welcome to the Notion-like editor for Novus!</p>",
    // );
    ...
    //         setIsSaving(false);
    //         // Success message or callback would go here
    //     } catch (error) {
    //         setIsSaving(false);
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="h-10 text-lg px-4 border-2 rounded-md shadow-none focus:ring-2 focus:ring-black dark:focus:ring-white dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                        />
                    </div>
