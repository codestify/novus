...
vi.mock("@tiptap/extension-task-list", () => ({
    default: { configure: vi.fn(() => ({ name: "TaskList" })) },
}));
...
vi.mock("@tiptap/extension-code-block-lowlight", () => ({
    default: { configure: vi.fn(() => ({ name: "CodeBlockLowlight" })) },
}));
...
vi.mock("@tiptap/extension-table-row", () => ({
    TableRow: { configure: vi.fn(() => ({ name: "TableRow" })) },
}));

vi.mock("@tiptap/extension-table-cell", () => ({
    TableCell: { configure: vi.fn(() => ({ name: "TableCell" })) },
}));

vi.mock("@tiptap/extension-table-header", () => ({
    TableHeader: { configure: vi.fn(() => ({ name: "TableHeader" })) },
}));

vi.mock("@tiptap/extension-image", () => ({
    Image: { configure: vi.fn(() => ({ name: "Image" })) },
}));

vi.mock("@tiptap/extension-text-align", () => ({
    TextAlign: { configure: vi.fn(() => ({ name: "TextAlign" })) },
}));
